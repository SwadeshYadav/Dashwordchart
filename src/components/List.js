...
const List = () => {
  ...
  return (
    <Container>
      <h2 className='text-[24px] font-bold text-center mt-3'>CyeNET List Data</h2>
      ...
      <Table className='mt-4 border border-gray-200'>
        <TableHead>
          <TableRow className="bg-gray-100">
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Scan Name</TableCell>
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Scan Engine</TableCell>
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Status</TableCell>
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Risk Score</TableCell>
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Total Vulnerabilities</TableCell>
            <TableCell sx={{ fontWeight: 'bold', fontSize: '16px', bgcolor: 'gray.400' }}>Severity</TableCell>
          </TableRow>
        </TableHead>  
        <TableBody> 
